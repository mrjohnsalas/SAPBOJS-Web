...
import { MaintenancePriority } from 'src/app/_models/maintenance-priority';
...
@Component({
  selector: 'app-maintenance-priorities-detail',
  templateUrl: './maintenance-priorities-detail.component.html',
  styleUrls: ['./maintenance-priorities-detail.component.scss']
})
export class MaintenancePrioritiesDetailComponent implements OnInit {

  objName = 'Prioridad de mantenimiento';
  deleteMode = false;
  isLoadingData = false;
  currentObj: MaintenancePriority;
  ...
  onDeleteSuccess(obj: MaintenancePriority) {
    this.stopLoading();
