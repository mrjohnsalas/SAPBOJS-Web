...
import { TimeFrequencyService } from '../../../_services/time-frequency.service';
...
@Component({
  selector: 'app-time-frequencies-list',
  templateUrl: './time-frequencies-list.component.html',
  styleUrls: ['./time-frequencies-list.component.scss']
})
export class TimeFrequenciesListComponent implements OnInit, AfterViewInit {

  objName = 'Frecuencia de tiempo';
  ids: number[];
  objs: TimeFrequency[];
  objsFiltered: TimeFrequency[];
  currentDate: string;
  isLoadingData = false;
  ...
  getOptionButtonBar(row: TimeFrequency): OptionButtonBar {
