...
import { TimeFrequency } from 'src/app/_models/time-frequency';
import { TimeFrequencyService } from 'src/app/_services/time-frequency.service';
import { TimeFrequencySharedService } from '../../../_services/time-frequency-shared.service';

@Component({
  selector: 'app-time-frequencies-detail',
  templateUrl: './time-frequencies-detail.component.html',
  styleUrls: ['./time-frequencies-detail.component.scss']
})
export class TimeFrequenciesDetailComponent implements OnInit {

  objName = 'Frecuencia de tiempo';
  deleteMode = false;
  isLoadingData = false;
  currentObj: TimeFrequency;
  spinnerType = SpinnerType;
  entityType = EntityType.TimeFrequency;
  serviceException: ServiceException;
  bgColor = BgColor;
  parentPath = 'timefrequencies';
  ...
  constructor(
    private objService: TimeFrequencyService,
    private router: Router,
    private activatedRoute: ActivatedRoute,
    private objSharedService: TimeFrequencySharedService,
  ...
  onDeleteSuccess(obj: TimeFrequency) {
    this.stopLoading();
