...
@Component({
  selector: 'app-time-frequencies-form',
  templateUrl: './time-frequencies-form.component.html',
  styleUrls: ['./time-frequencies-form.component.scss']
})
export class TimeFrequenciesFormComponent implements OnInit, CanDeactivateRoute {
  ...
  submit() {
    ...
    const formObj: TimeFrequency = Object.assign({}, this.formGroup.value);
  ...
  onSaveSuccess(obj: TimeFrequency) {
    this.stopLoading();
